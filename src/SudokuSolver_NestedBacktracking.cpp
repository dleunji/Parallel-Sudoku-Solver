#include "SudokuSolver_NestedBacktracking.hpp"
#include <iostream>

SudokuSolver_NestedBacktracking::SudokuSolver_NestedBacktracking(SudokuBoard &board, bool print_message /*=true*/)
    : SudokuSolver(board)
{
...
bool SudokuSolver_NestedBacktracking::solve_kernel()
{
    if (_solved)
    {
        return _solved;
